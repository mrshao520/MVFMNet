...
class BaseModel():
    ...
    def _print_different_keys_loading(self, crt_net, load_net, strict=True):
        ...
        if crt_net_keys != load_net_keys:
            logger.warning(f'Current net - loaded net: {len(list(crt_net_keys - load_net_keys))}')
            for v in sorted(list(crt_net_keys - load_net_keys)):
                logger.warning(f'  {v}')
            logger.warning(f'Loaded net - current net:{len(list(load_net_keys - crt_net_keys))}')
